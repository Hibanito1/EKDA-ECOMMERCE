...
export const metadata: Metadata = { title: "Carrier Documents" };
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold">Carrier Documents</h1>
          <p className="text-muted-foreground text-sm">Licenses and certifications</p>
        </div>
      </div>
