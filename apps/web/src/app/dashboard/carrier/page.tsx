...
export const metadata: Metadata = { title: "Carrier Overview" };

export default function DashboardCarrierPage() {
  return (
    <div className="max-w-3xl space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold">Carrier Overview</h1>
          <p className="text-muted-foreground text-sm">Jobs, bids, and earnings</p>
        </div>
      </div>
